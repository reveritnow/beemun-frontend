      ...
      <section className="product-page">
        ...
        <div className="product-layout">
          ...
          <aside className="product-panel">
            ...
            <div className="hero-actions"><a className="btn-primary" href="/cart">Add to Cart</a><a className="btn-secondary" href="/brand/earth-roots">View Maker</a></div>
            <ZpsTrustCard />
          </aside>
        </div>
        ...
        <section className="product-info-section"><p className="section-eyebrow">Delivery and support</p><h2>Shipping, tracking, and returns</h2><div className="three-grid"><div className="info-card"><h3>Ships from maker</h3><p>The maker packs and dispatches the product after order confirmation.</p></div><div className="info-card"><h3>Tracking in account</h3><p>Courier details appear inside your BEEMUN order page when available.</p></div><div className="info-card"><h3>Support connected</h3><p>Order questions can be raised from your account order detail page.</p></div></div></section>
